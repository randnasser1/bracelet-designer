...
// Configure email transporter for Gmail - FIXED: createTransport (not createTransporter)
...
exports.sendOrderEmails = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const adminEmail = {
            ...
            to: 'italiacharmshop@gmail.com', // Your email from login
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    ...
                    <div style="margin-top: 20px; text-align: center;">
                        <p><a href="https://console.firebase.google.com/project/${process.env.GCLOUD_PROJECT}/firestore/data/~2Forders~2F${orderId}" style="background: #d6336c; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">View in Firebase Console</a></p>
                    </div>
                </div>
            `
        };
